...
<div className="flex flex-col min-h-screen w-full justify-around items-center py-12 px-4 bg-black">
  {/* Heading */}
  <div className="font-extrabold text-4xl md:text-5xl text-red-400 text-center mb-4"
...
<div className="flex flex-col min-h-screen w-full justify-around items-center py-12 px-4 bg-black">
  {/* Heading */}
  <div
    className="font-extrabold text-4xl md:text-5xl text-red-400 text-center mb-4"
    style={{ textShadow: "2px 2px 4px rgba(0, 0, 0, 0.8)" }}
  >
    Our Services
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
    ...
    {/* Rent Section */}
    <div
      className="bg-white p-6 rounded-xl border-2 border-transparent hover:border-red-400 transition-transform duration-500 transform hover:scale-105 shadow-lg hover:shadow-2xl"
  ...
  <div className="flex justify-center py-6">
    <a
      href="/"
      className="bg-red-400 text-white text-lg font-semibold py-3 px-6 rounded-md shadow hover:bg-yellow-400 transition duration-200 hover:scale-105"
    >
      Explore More
    </a>
  </div>
...
<div className="flex justify-center py-6">
  <Link 
    to="/" 
    className="bg-red-400 text-white text-lg font-semibold py-3 px-6 rounded-md shadow hover:bg-yellow-400 transition duration-200"
  >
    Explore More
  </Link>
</div> 
